...
import { withCanonicalWorkspaceBrandAssets } from "@/lib/workspace-brand-assets";
...
export function applyWorkspaceBrandSettings(
  ...
  if (!rows.length) return withCanonicalWorkspaceBrandAssets(brand);
  ...
  return withCanonicalWorkspaceBrandAssets({
    ...brand,
