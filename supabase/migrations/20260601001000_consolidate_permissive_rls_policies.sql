...
--
-- Every policy is scoped `to authenticated` to match the rest of the hardened
-- policy set (anon has no session, so the private.* helpers return false for it,
-- but we keep the role surface explicit and consistent — no accidental `public`).
--
...
begin
  foreach t in array array['app_banners','challenges'] loop
    ...
    execute format($f$create policy catalog_read on public.%I for select to authenticated
    ...
    execute format($f$create policy catalog_write_team_insert on public.%I for insert to authenticated
    ...
    execute format($f$create policy catalog_write_team_update on public.%I for update to authenticated
      ...
      with check (private.has_workspace_role(workspace_id, array['platform_owner'::workspace_role,'agency_admin'::workspace_role,'coach_admin'::workspace_role,'coach_staff'::workspace_role]))$f$, t);
    execute format($f$create policy catalog_write_team_delete on public.%I for delete to authenticated
...
create policy "supplements readable by workspace" on public.supplements for select to authenticated
  using (private.is_workspace_member(workspace_id)
...
create policy "supplements team insert" on public.supplements for insert to authenticated
...
create policy "supplements team update" on public.supplements for update to authenticated
  using (private.has_workspace_role(workspace_id, array['platform_owner'::workspace_role,'agency_admin'::workspace_role,'coach_admin'::workspace_role,'coach_staff'::workspace_role]))
  with check (private.has_workspace_role(workspace_id, array['platform_owner'::workspace_role,'agency_admin'::workspace_role,'coach_admin'::workspace_role,'coach_staff'::workspace_role]));
create policy "supplements team delete" on public.supplements for delete to authenticated
  using (private.has_workspace_role(workspace_id, array['platform_owner'::workspace_role,'agency_admin'::workspace_role,'coach_admin'::workspace_role,'coach_staff'::workspace_role]));
...
create policy "member subscriptions readable by owner and team" on public.member_subscriptions for select to authenticated
  using (private.is_member_profile_owner(workspace_id, member_profile_id)
         or private.has_workspace_role(workspace_id, array['platform_owner'::workspace_role,'agency_admin'::workspace_role,'coach_admin'::workspace_role,'coach_staff'::workspace_role]));
create policy "member subscriptions team insert" on public.member_subscriptions for insert to authenticated
  with check (private.has_workspace_role(workspace_id, array['platform_owner'::workspace_role,'agency_admin'::workspace_role,'coach_admin'::workspace_role,'coach_staff'::workspace_role]));
create policy "member subscriptions team update" on public.member_subscriptions for update to authenticated
  using (private.has_workspace_role(workspace_id, array['platform_owner'::workspace_role,'agency_admin'::workspace_role,'coach_admin'::workspace_role,'coach_staff'::workspace_role]))
  with check (private.has_workspace_role(workspace_id, array['platform_owner'::workspace_role,'agency_admin'::workspace_role,'coach_admin'::workspace_role,'coach_staff'::workspace_role]));
create policy "member subscriptions team delete" on public.member_subscriptions for delete to authenticated
  using (private.has_workspace_role(workspace_id, array['platform_owner'::workspace_role,'agency_admin'::workspace_role,'coach_admin'::workspace_role,'coach_staff'::workspace_role]));
...
create policy "recipe ingredients read" on public.recipe_ingredients for select to authenticated
  using (
...
create policy "recipe ingredients team insert" on public.recipe_ingredients for insert to authenticated
...
create policy "recipe ingredients team update" on public.recipe_ingredients for update to authenticated
  ...
  with check (exists (select 1 from recipes r where r.id = recipe_ingredients.recipe_id and private.has_workspace_role(r.workspace_id, array['platform_owner'::workspace_role,'agency_admin'::workspace_role,'coach_admin'::workspace_role,'coach_staff'::workspace_role])));
create policy "recipe ingredients team delete" on public.recipe_ingredients for delete to authenticated
  using (exists (select 1 from recipes r where r.id = recipe_ingredients.recipe_id and private.has_workspace_role(r.workspace_id, array['platform_owner'::workspace_role,'agency_admin'::workspace_role,'coach_admin'::workspace_role,'coach_staff'::workspace_role])));
